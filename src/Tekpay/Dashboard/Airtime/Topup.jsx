...
import TopupItem from '../Airtime/TopupItem'
    ...
    <div className="dashboard-section">
        ...
        <div className="row">
           ...
           <div className='sidebar shadow'>
              ...
              <div className='sidebar-item-icon ' onClick={e => navigate('/dashboard')}>< Dashboard/> Home</div>
               <div className='sidebar-item-icon active' onClick={e => navigate('/topup')}>< AssignmentOutlined/> Airtime topup</div> 
